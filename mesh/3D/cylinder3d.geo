...
Cylinder(2) = {0.75,0.5,0.5, 0,1,0, 0.2, 2*Pi};
...
Physical Volume(1) = {3};
Physical Surface(1) = {1};   // The surface on the positive x side of the box  --> Inlet
...
Physical Surface(4) = {6};    // The surface on the negative x side of the box --> Outlet
